...
import { APIAllowedMentions, APIEmbed, APIMessageReference, APIUserPartial, APIRole, RESTUpdateRoleBody, APIGuildMember, APIGuildMemberSearchRequest, APIGuildMemberSearchResponse, APIWebhook, APIWebhookUpdateRequest, APIWebhookTokenUpdateRequest, APIWebhookEditMessageRequest, APIBan, APIEmoji, APISticker, APIGuildPartial, APIChannelPartial, APIInvite, GuildFeature, GuildVerificationLevel, DefaultMessageNotifications, GuildExplicitContentFilter, GuildMFALevel, APIGuild, RESTCreateRoleBody, APIGuildAuditLog, APIVanityURL, GatewayReactionEmoji, GatewayMessageReactionAddDispatchData, GatewayMessageReactionRemoveDispatchData, APIMessageAttachment, MessageType, APIMessageSticker, APIMessageReaction, APIMessageSnapshot, APIMessageCall, APIMessage, APIChannelOverwrite, APIChannel, ChannelType, APIRtcRegion, APIChannelSlowmodeState, GatewayPresenceUpdateData, APIProfileResponse, APIApplicationCommandInteraction, APIApplicationCommandOptionValue, GatewayMessageReactionRemoveAllDispatchData, GatewayMessageReactionRemoveEmojiDispatchData, GatewayGuildMembersChunkDispatchData, GatewayVoiceStateUpdateDispatchData, GatewayVoiceServerUpdateDispatchData, GatewayMessageDeleteBulkDispatchData, GatewayGuildEmojisUpdateDispatchData, GatewayGuildStickersUpdateDispatchData, GatewayGuildIntegrationsUpdateDispatchData, GatewayGuildRoleCreateDispatchData, GatewayGuildRoleUpdateDispatchData, GatewayGuildRoleDeleteDispatchData, GatewayGuildScheduledEventCreateDispatchData, GatewayGuildScheduledEventUpdateDispatchData, GatewayGuildScheduledEventDeleteDispatchData, GatewayChannelPinsUpdateDispatchData, GatewayInviteDeleteDispatchData, GatewayTypingStartDispatchData, GatewayUserUpdateDispatchData, GatewayPresenceUpdateDispatchData, GatewayWebhooksUpdateDispatchData, APIInstance, APIGatewayBotResponse, GatewaySendPayload, Routes } from '@fluxerjs/types';
 ...
 */
declare function prepareMessagePostPayload(options: string | MessageSendOptions): Promise<MessagePostPayload>;
...
declare class GuildMemberManager extends Collection<string, GuildMember> {
     ...
     */
    search(options: APIGuildMemberSearchRequest): Promise<APIGuildMemberSearchResponse>;
}
...
type WebhookMessageEditOptions = Omit<APIWebhookEditMessageRequest, 'embeds'> & {
    embeds?: (APIEmbed | EmbedBuilder)[];
};
/**
...
type MessagePayload = Awaited<ReturnType<typeof prepareMessagePostPayload>>;
...
declare abstract class Channel extends Base {
     ...
     */
    fetchRtcRegions(): Promise<APIRtcRegion[]>;
    /**
     * Fetch the current user's slowmode state in this channel.
     * GET /channels/{id}/slowmode
     */
    fetchSlowmode(): Promise<APIChannelSlowmodeState>;
    /**
 ...
 */
declare class ChatInputCommandInteraction extends BaseInteraction {
    constructor(client: Client, raw: APIApplicationCommandInteraction);
...
type AnyInteraction = ChatInputCommandInteraction | BaseInteraction;
/**
 ...
 */
declare function createInteraction(client: Client, data: APIApplicationCommandInteraction): AnyInteraction;
declare function isChatInputCommandInteraction(interaction: AnyInteraction): interaction is ChatInputCommandInteraction;
...
declare class Client extends EventEmitter {
     ...
     */
    private _deferredGatewayDispatches;
     ...
     * Does not require authentication.
     */
    fetchInstanceDiscovery(): Promise<APIInstance>;
    /**
     ...
     */
    private _shouldDeferGatewayDispatchUntilReady;
    /**
    ...
    private _dispatchGatewayPayload;
    private _flushDeferredGatewayDispatches;
    /**
...
export { createInteraction as $, AllowedMentions as A, Base as B, type CacheSizeLimits as C, DMChannel as D, Events as E, type FetchMessagesOptions as F, Guild as G, MessageReaction as H, Invite as I, type MessageReplyTarget as J, type MessageSendOptions as K, LinkChannel as L, Message as M, type ReactionCollectorEndReason as N, type ReactionCollectorOptions as O, type PartialMessage as P, type ReplyOptions as Q, ReactionCollector as R, Role as S, type RoleResolvable as T, TextChannel as U, User as V, UsersManager as W, VoiceChannel as X, Webhook as Y, type WebhookMessageEditOptions as Z, type WebhookSendOptions as _, type AllowedMentionsOptions as a, isChatInputCommandInteraction as a0, type AnyInteraction as b, BaseInteraction as c, CategoryChannel as d, Channel as e, ChannelManager as f, ChatInputCommandInteraction as g, Client as h, type ClientEventMethods as i, type ClientEvents as j, type ClientOptions as k, ClientUser as l, type CollectedReaction as m, type FetchedUserWithProfile as n, GuildBan as o, GuildChannel as p, GuildEmoji as q, GuildMember as r, GuildMemberManager as s, GuildMemberRoleManager as t, GuildSticker as u, MessageCollector as v, type MessageCollectorEndReason as w, type MessageCollectorOptions as x, type MessageEditOptions as y, MessageManager as z };
