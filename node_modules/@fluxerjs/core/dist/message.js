...
// src/subpath-message.ts
var subpath_message_exports = {};
__export(subpath_message_exports, {
  Message: () => Message
});
module.exports = __toCommonJS(subpath_message_exports);
  ...
  for (let i = 0; i < files.length; i++) {
    ...
    if ("url" in f && f.url) {
      if (!URL.canParse(f.url)) {
        throw new import_util2.FluxerError(`Invalid file URL at index ${i}: ${f.url}`, {
      ...
      try {
        ...
        throw new import_util2.FluxerError(`Failed to fetch file from ${f.url}`, {
