...
// src/subpath-request-manager.ts
var subpath_request_manager_exports = {};
__export(subpath_request_manager_exports, {
  RequestManager: () => RequestManager
});
module.exports = __toCommonJS(subpath_request_manager_exports);
      ...
      try {
        ...
        if (!response.ok) {
          ...
          try {
            ...
            throw new HTTPError(response.status, text2);
          }
